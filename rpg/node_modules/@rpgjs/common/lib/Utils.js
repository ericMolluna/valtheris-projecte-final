...
export function intersection([start1, end1], [start2, end2]) {
...
export function hexaToNumber(hexa) {
...
export function fps2ms(fps) {
    return 1000 / fps;
}
export function preciseNow() {
    return typeof performance !== 'undefined' ? performance.now() : Date.now();
}
export function round(num, decimals = 100) {
...
;
export function elementToPositionAbsolute(element) {
