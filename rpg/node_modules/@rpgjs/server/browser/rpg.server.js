...
function requireBufferishProto() {
  ...
  bufferishProto.toString = toString5;
  ...
  function toString5(encoding, start, end) {
...
function requireBufferish() {
  ...
  (function(exports) {
    ...
    function concat2(list, length) {
      ...
      var offset = 0;
      Array.prototype.forEach.call(list, append3);
      return result;
      function dryrun(buffer) {
        length += buffer.length;
      }
      function append3(buffer) {
...
function filter$1(filter4) {
  return IS_ARRAY(filter4) ? join$1(filter4) : filter4;
}
...
class TiledParser {
  ...
  static unpackTileBytes(buffer, size) {
    ...
    for (let i = 0; i < expectedCount; i += 4) {
      array2[tileIndex] = buffer.readUInt32LE(i);
      tileIndex++;
    }
    return array2;
  }
...
const toFlatObject$1 = (sourceObj, destObj, filter4, propFilter) => {
  let props;
  let i;
  let prop;
  const merged = {};
  ...
  do {
    ...
    sourceObj = filter4 !== false && getPrototypeOf$1(sourceObj);
...
AxiosError$1.from = (error, code, config2, request, response, customProps) => {
  ...
  utils$1.toFlatObject(error, axiosError, function filter4(obj) {
...
function matchHeaderValue$1(context, value, header, filter4, isHeaderNameFilter) {
...
const cookies$1 = platform$1.isStandardBrowserEnv ? (
  ...
  function standardBrowserEnv() {
    return {
      write: function write5(name, value, expires, path2, domain2, secure) {
        const cookie = [];
...
class Gui extends EventEmitter$1 {
...
(function(Direction3) {
  ...
  Direction3[Direction3["UpRight"] = 1.5] = "UpRight";
  Direction3[Direction3["DownRight"] = 2.5] = "DownRight";
  Direction3[Direction3["DownLeft"] = 3.5] = "DownLeft";
  Direction3[Direction3["UpLeft"] = 2.5] = "UpLeft";
...
var Control2;
(function(Control3) {
  Control3["Action"] = "action";
  Control3["Attack"] = "attack";
  Control3["Defense"] = "defense";
  Control3["Skill"] = "skill";
  Control3["Back"] = "back";
  Control3[Control3["Up"] = 1] = "Up";
  Control3[Control3["Down"] = 3] = "Down";
  Control3[Control3["Right"] = 2] = "Right";
  Control3[Control3["Left"] = 4] = "Left";
})(Control2 || (Control2 = {}));
var Input2;
(function(Input3) {
  Input3["Break"] = "break";
  Input3["Backspace"] = "backspace";
  Input3["Tab"] = "tab";
  Input3["Clear"] = "clear";
  Input3["Enter"] = "enter";
  Input3["Shift"] = "shift";
  Input3["Ctrl"] = "ctrl";
  Input3["Alt"] = "alt";
  Input3["Pause"] = "pause/break";
  Input3["CapsLock"] = "caps lock";
  Input3["Escape"] = "escape";
  Input3["Conversion"] = "conversion";
  Input3["NonConversion"] = "non-conversion";
  Input3["Space"] = "space";
  Input3["PageUp"] = "page up";
  Input3["PageDown"] = "page down";
  Input3["End"] = "end";
  Input3["Home"] = "home";
  Input3[Input3["Left"] = 4] = "Left";
  Input3[Input3["Up"] = 1] = "Up";
  Input3[Input3["Right"] = 2] = "Right";
  Input3[Input3["Down"] = 3] = "Down";
  Input3["Select"] = "select";
  Input3["Print"] = "print";
  Input3["Execute"] = "execute";
  Input3["PrintScreen"] = "Print Screen";
  Input3["Insert"] = "insert";
  Input3["Delete"] = "delete";
  Input3["Zero"] = "0";
  Input3["One"] = "1";
  Input3["Two"] = "2";
  Input3["Three"] = "3";
  ...
  Input3["Nine"] = "9";
  Input3["Equal"] = "=";
  Input3["Semicolon"] = "semicolon (firefox), equals";
  Input3["LessThan"] = "<";
  Input3["Equals"] = "equals (firefox)";
  Input3["Beta"] = "ß";
  Input3["At"] = "@";
  Input3["A"] = "a";
  Input3["B"] = "b";
  ...
  Input3["Y"] = "y";
  Input3["Z"] = "z";
  Input3["SearchKey"] = "Windows Key / Left ⌘ / Chromebook Search key";
  Input3["NumPad0"] = "numpad 0";
  Input3["NumPad1"] = "numpad 1";
  Input3["NumPad2"] = "numpad 2";
  Input3["NumPad3"] = "numpad 3";
  Input3["NumPad4"] = "numpad 4";
  Input3["NumPad5"] = "numpad 5";
  Input3["NumPad6"] = "numpad 6";
  Input3["NumPad7"] = "numpad 7";
  Input3["NumPad8"] = "numpad 8";
  Input3["NumPad9"] = "numpad 9";
  Input3["Multiply"] = "multiply";
  Input3["Add"] = "add";
  Input3["Subtract"] = "subtract";
  Input3["DecimalPoint"] = "decimal point";
  Input3["Divide"] = "divide";
  Input3["F1"] = "f1";
  Input3["F2"] = "f2";
  Input3["F3"] = "f3";
  Input3["F4"] = "f4";
  ...
  Input3["F23"] = "f23";
  Input3["F24"] = "f24";
  Input3["NumLock"] = "num lock";
  Input3["ScrollLock"] = "scroll lock";
  Input3["CircumflexAccent"] = "^";
  Input3["ExclamationMark"] = "!";
  Input3["Hash"] = "#";
  Input3["Dollar"] = "$";
  Input3["AccentU"] = "ù";
  Input3["PageBackward"] = "page backward";
  Input3["PageForWard"] = "page forward";
  Input3["Star"] = "*";
  Input3["DecreaseVolume"] = "decrease volume level";
  Input3["IncreaseVolume"] = "increase volume level";
  Input3["Next"] = "next";
  Input3["Previous"] = "previous";
  Input3["Stop"] = "stop";
  Input3["PlayPause"] = "play/pause";
  Input3["Email"] = "e-mail";
  Input3["SemiColon"] = "semi-colon / ñ";
  Input3["EqualSign"] = "equal sign";
  Input3["Comma"] = "comma";
  Input3["Dash"] = "dash";
  Input3["FowardSlach"] = "forward slash / ç";
  Input3["GraveAccent"] = "grave accent / ñ / æ";
  Input3["OpenBracket"] = "open bracket";
  Input3["BackSlach"] = "back slash";
  Input3["CloseBracket"] = "close bracket / å";
  Input3["SingleQuote"] = "single quote / ø";
  Input3["BackQuote"] = "`";
  Input3["Altgr"] = "altgr";
})(Input2 || (Input2 = {}));
...
class MoveList {
  ...
  right(repeat = 1) {
    return this.repeatMove(Direction$1.Right, repeat);
  }
  left(repeat = 1) {
    return this.repeatMove(Direction$1.Left, repeat);
  }
  up(repeat = 1) {
    return this.repeatMove(Direction$1.Up, repeat);
  }
  down(repeat = 1) {
    return this.repeatMove(Direction$1.Down, repeat);
  }
  wait(sec) {
    return wait(sec);
  }
  random(repeat = 1) {
    return new Array(repeat).fill(null).map(() => [Direction$1.Right, Direction$1.Left, Direction$1.Up, Direction$1.Down][random(0, 3)]);
  }
  tileRight(repeat = 1) {
    ...
    switch (directionOtherPlayer) {
      ...
      case Direction$1.Right:
        if (otherPlayer.position.x > player.position.x) {
          newDirection = Direction$1.Left;
        } else {
          newDirection = Direction$1.Right;
        }
        break;
      case Direction$1.Up:
      case Direction$1.Down:
        if (otherPlayer.position.y > player.position.y) {
          newDirection = Direction$1.Up;
        } else {
          newDirection = Direction$1.Down;
        }
        break;
    }
    return newDirection;
  ...
  turnLeft() {
    return "turn-" + Direction$1.Left;
  }
  turnRight() {
    return "turn-" + Direction$1.Right;
  }
  turnUp() {
    return "turn-" + Direction$1.Up;
  }
  turnDown() {
    return "turn-" + Direction$1.Down;
  }
  turnRandom() {
      ...
      const move = () => {
        ...
        switch (route) {
          ...
          case Direction$1.Up:
            ...
            break;
          case "turn-" + Direction$1.Left:
            ob$ = of(this.changeDirection(Direction$1.Left));
            break;
          case "turn-" + Direction$1.Right:
            ob$ = of(this.changeDirection(Direction$1.Right));
            break;
          case "turn-" + Direction$1.Up:
            ob$ = of(this.changeDirection(Direction$1.Up));
            break;
          case "turn-" + Direction$1.Down:
            ob$ = of(this.changeDirection(Direction$1.Down));
            break;
        }
        return ob$.pipe(tap(() => {
          routes.shift();
...
class ComponentManager {
   ...
   */
  setGraphic(graphic) {
    const components = Utils$1.isArray(graphic) ? graphic : [graphic];
    const col = [...components.map((value) => ({
      id: Utils$1.isString(value) ? "graphic" : "tile",
      value
    }))];
...
const _RpgPlayer = class extends RpgCommonPlayer {
  ...
  async autoChangeMap(nextPosition) {
    ...
    if (worldMaps && map) {
      ...
      if (nextPosition.x < marginLeftRight && direction == Direction$1.Left) {
        ret = await changeMap({
          x: map.worldX - 1,
      ...
      } else if (nextPosition.x > map.widthPx - this.wHitbox - marginLeftRight && direction == Direction$1.Right) {
        ret = await changeMap({
      ...
      } else if (nextPosition.y < marginTopDown && direction == Direction$1.Up) {
        ret = await changeMap({
      ...
      } else if (nextPosition.y > map.heightPx - this.hHitbox - marginTopDown && direction == Direction$1.Down) {
        ret = await changeMap({
          x: this.worldPositionX + 1,
  ...
  async load(json) {
    ...
    for (let key in json) {
      const val = json[key];
      if (Utils$1.isObject(val) && val.hasOwnProperty("0")) {
...
Utils$1.applyMixins(RpgMap, [EventManager]);
class RpgWorldMaps extends RpgCommonWorldMaps {
  load(world, sceneMap) {
    for (let worldMap of world.maps) {
      ...
      if (worldMap.id) {
        id = worldMap.id;
      } else if (Utils$1.isString(fileName)) {
        id = Utils$1.extractId(fileName);
      }
...
class SceneMap {
  ...
  getMapBydId(id) {
    ...
    if (!Utils$1.isClass(mapClass))
      mapClass = Utils$1.createConstructor(mapClass);
    return mapClass;
  }
  async loadMap(id) {
  ...
  */
  createDynamicWorldMaps(world) {
    world.id = world.id || Utils$1.generateUID();
  ...
  */
  ...
  createDynamicMap(mapData) {
    if (Utils$1.isString(mapData)) {
      const id = Utils$1.extractId(mapData);
      if (!id) {
    ...
    if (!mapData.id)
      mapData.id = Utils$1.generateUID();
    if (!Utils$1.isClass(mapData)) {
...
class RpgServerEngine {
  constructor() {
    ...
    this.globalConfig = {};
    this.damageFormulas = {};
    this.serverId = {}.SERVER_ID || Utils$1.generateUID();
  ...
  async _init() {
    ...
    this.inputOptions.maps = [...Utils$1.arrayFlat(await RpgPlugin.emit(HookServer.AddMap, this.inputOptions.maps)) || [], ...this.inputOptions.maps];
    this.inputOptions.events = [...Utils$1.arrayFlat(await RpgPlugin.emit(HookServer.AddEvent, this.inputOptions.events)) || [], ...this.inputOptions.events];
    this.inputOptions.worldMaps = [...Utils$1.arrayFlat(await RpgPlugin.emit(HookServer.AddWorldMaps, this.inputOptions.worldMaps)) || [], ...this.inputOptions.worldMaps];
  ...
  addInDatabase(id, dataClass, type) {
    ...
    switch (type) {
      case "item":
        ...
        ItemClass = __decorateClass([Item$1(dataClass)], ItemClass);
        this.database[id] = ItemClass;
        break;
      case "weapon":
        let WeaponClass = class {
        };
        WeaponClass = __decorateClass([Weapon(dataClass)], WeaponClass);
        this.database[id] = WeaponClass;
        break;
      case "armor":
        let ArmorClass = class {
        };
        ArmorClass = __decorateClass([Armor(dataClass)], ArmorClass);
        this.database[id] = ArmorClass;
        break;
      case "skill":
        let SkillClass = class {
        };
        SkillClass = __decorateClass([Skill(dataClass)], SkillClass);
        this.database[id] = SkillClass;
        break;
      case "class":
        let ClassClass = class {
        };
        ClassClass = __decorateClass([Class(dataClass)], ClassClass);
        this.database[id] = ClassClass;
        break;
      case "state":
        let StateClass = class {
        };
        StateClass = __decorateClass([State(dataClass)], StateClass);
        this.database[id] = StateClass;
        break;
      case "actor":
        let ActorClass = class {
        };
        ActorClass = __decorateClass([Actor(dataClass)], ActorClass);
...
const predicates = utils.toFlatObject(utils, {}, null, function filter3(prop) {
  return /^is[A-Z]/.test(prop);
});
...
prototype.toString = function toString4(encoder2) {
  const _encode = encoder2 ? function(value) {
...
const InterceptorManager$1 = InterceptorManager2;
...
utils.freezeMethods(AxiosHeaders2.prototype);
utils.freezeMethods(AxiosHeaders2);
const AxiosHeaders$1 = AxiosHeaders2;
...
const CancelToken$1 = CancelToken2;
