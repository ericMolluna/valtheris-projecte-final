import { Utils as Utils$1 } from "@rpgjs/common";
import { entryPoint as entryPoint$2 } from "@rpgjs/server";
import { entryPoint as entryPoint$1 } from "@rpgjs/client";
...
function entryPoint(modules, options = {}) {
  ...
  class StandaloneGame {
    async start() {
      this.client = entryPoint$1(modules, {
        standalone: true,
        io,
        globalConfig: options.globalConfigClient,
        ...options
      });
      this.server = await entryPoint$2(modules, {
        io: serverIo,
        standalone: true,
        basePath: "",
